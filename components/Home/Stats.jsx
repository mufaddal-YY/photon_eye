            ...
            <div className="flex flex-wrap p-3">
              {data.map((item, index) => (
                <div className="w-full lg:w-1/2 py-2 lg:p-2" key={index}>
                  <div
                    className={`rounded-xl border duration-1000 h-[250px] p-8 ${index === 0 ? "bg-blue-800 text-gray-50" : "bg-gray-50 border-blue-800 hover:border-[#2fb1d2] hover:bg-[#2fb1d2] text-blue-800 hover:text-gray-100"} ${index === 3 ? "bg-[#2fb1d2] border-[#2fb1d2] text-gray-50" : "bg-gray-50 border-blue-800 hover:border-[#2fb1d2] hover:bg-[#2fb1d2] text-blue-800 hover:text-gray-100"}`}>
